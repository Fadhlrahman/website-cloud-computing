    ...
    <div className="min-h-screen overflow-x-hidden bg-belakang flex flex-col items-center">
      ...
      <div className="container mx-auto p-8 bg-element shadow-lg rounded-2xl mt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Text Content */}
          <div className="flex flex-col items-center justify-center p-6 bg-element2 text-element rounded-lg shadow-md">
      ...
      <div className="container mx-auto mt-10 p-6 bg-element2 rounded-lg shadow-md text-center max-w-2xl">
